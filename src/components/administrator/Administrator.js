...
const Administrator = (props) => {
    ...
    useEffect(() => {
        const fetchStaffAndPatients = async () => {
            ...
            try {
                const staffData = await axios.get('https://asclepius-server.herokuapp.com/api/get/staff/info/id', {params: staff});
                // console.log("Response for the staff data", staffData.data[0]);
                setStaffInfo(staffData.data[0]);

                const allStaff = await axios.get('https://asclepius-server.herokuapp.com/api/get/staff');
                // console.log("Response for the all staff", allStaff.data);
                setAllStaff(allStaff.data);

                const allDoctors = await axios.get('https://asclepius-server.herokuapp.com/api/get/staff/doctors');
                // console.log("Response for the all doctors", allDoctors.data);
                setAllDoctors(allDoctors.data);

                const allNurses = await axios.get('https://asclepius-server.herokuapp.com/api/get/staff/nurses');
                // console.log("Response for the all nurses", allNurses.data);
                setAllNurses(allNurses.data);

                const allPatients = await axios.get('https://asclepius-server.herokuapp.com/api/get/patients');
                // console.log("Response for the patients data", allPatients.data);
                setAllPatients(allPatients.data);

                const allAssignments = await axios.get('https://asclepius-server.herokuapp.com/api/get/assignments');
                // console.log("Response for the assignments data", allAssignment.data);
                setAllAssignments(allAssignments.data);

                const inventoryData = await axios.get('https://asclepius-server.herokuapp.com/api/get/inventory');
    ...
    const makeAssignment = async (assignment) => {
        ...
        await axios.post("https://asclepius-server.herokuapp.com/api/post/staff/assignment", assignment).then((response) => {
    ...
    const addPatient = async (patientData) => {
        ...
        await axios.post("https://asclepius-server.herokuapp.com/api/post/patients/newpatient", patientData).then((response) => {
            console.log("This is the response from catch: ", response);
        }).then(() => {
    ...
    const removePatient = async (patientData) => {
        console.log("This is from administrator ", patientData);
        await axios.delete("https://asclepius-server.herokuapp.com/api/delete/patients/remove", {params : patientData}).then((response) => {
            console.log("This is the response from catch: ", response);
        }).then(() => {
    ...
    const removeStaff = async (staffData) => {
        ...
        await axios.delete("https://asclepius-server.herokuapp.com/api/delete/staff/remove", {params : staffData}).then((response) => {
            console.log("This is the response from catch: ", response);
        }).then(() => {
    ...
    const removeAssignment = async (assignmentData) => {
        ...
        await axios.delete("https://asclepius-server.herokuapp.com/api/delete/assignments/remove", {params : assignmentData}).then((response) => {
            console.log("This is the response from catch: ", response);
        }).then(() => {
