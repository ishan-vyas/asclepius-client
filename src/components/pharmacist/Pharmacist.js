...
const Pharmacist = (props) => {
    ...
    const handleMakeOrder = async (medication_ID, amount) => {
        if(amount <= 0 ){
            ...
            await axios.put("https://asclepius-server.herokuapp.com/api/put/inventory/info", inventoryParams);
    ...
    const handleFulfillOrder = async (order) => {
        ...
        if(newMedAmount < 0) {
            ...
            await axios.put("https://asclepius-server.herokuapp.com/api/put/prescriptions/info", prescriptionParams);
    ...
    const handleAddMedication = async (medicationData) => {
        ...
        await axios.post("https://asclepius-server.herokuapp.com/api/post/medications/new", medicationData).then((response) => {
        ...
        // get its id
        const medicationRes = await axios.get('https://asclepius-server.herokuapp.com/api/get/inventory/info/id', {params: medicationData});
        ...
        await axios.post("https://asclepius-server.herokuapp.com/api/post/inventory/new", {medicationID: medicationID, stock: medicationData.stock}).then((response) => {
            console.log("This is the response from catch: ", response);
        }).then(() => {
            setSuccessMessage("Medication has been added!");
        }).catch((err) => {
    ...
    const handleDeleteMedication = async (medicationData) => {
        ...
        await axios.delete("https://asclepius-server.herokuapp.com/api/delete/medication/remove", {params : medicationData}).then((response) => {
            console.log("This is the response from catch: ", response);
        }).then(() => {
    ...
    useEffect(() => {
        const fetchStaffAndPatients = async () => {
            ...
            try {
                ...
                const orderData = await axios.get('https://asclepius-server.herokuapp.com/api/get/prescriptions/orders');
