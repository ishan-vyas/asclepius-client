...
const Patient = (props) => {
    ...
    useEffect(() => {
        const fetchPatientInformation = async () => {
            try {
                const diagnosesData = await axios.get('https://asclepius-server.herokuapp.com/api/get/diagnoses',
                    { params: props.patientFile }
                );
                setDiagnoses(diagnosesData.data.reverse());

                const prescriptions = await axios.get('https://asclepius-server.herokuapp.com/api/get/prescriptions/patient',
                    { params: props.patientFile }
                );
                setPrescriptions(prescriptions.data);

                const notes = await axios.get('https://asclepius-server.herokuapp.com/api/get/medical_notes',
                    { params: props.patientFile }
                );
                ...
                const allMedication = await axios.get('https://asclepius-server.herokuapp.com/api/get/medications');
    ...
    const addDiagnosis = async (newDiagnosis) => {
        ...
        await axios.post("https://asclepius-server.herokuapp.com/api/post/diagnoses/newdiagnosis", newDiagnosis).then((response) => {
    ...
    const addNote = async (newNote) => {
        ...
        await axios.post("https://asclepius-server.herokuapp.com/api/post/medical_notes/newnotes", newNote).then((response) => {
            console.log("This is the response from catch: ", response);
        }).then(() => {
            setSuccessMessage("Patient has been added!");
        }).catch((err) => {
    ...
    const deleteMedication = async (ID) => {
        ...
        await axios.delete("https://asclepius-server.herokuapp.com/api/delete/prescription/remove", { params: ID }).then((response) => {
            console.log("This is the response from catch: ", response);
        }).then(() => {
            setSuccessMessage("Patient has been added!");
        }).catch((err) => {
