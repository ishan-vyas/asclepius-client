...
const Doctor = (props) => {
    ...
    const handleAddPrescription = async (prescData) => {
        await axios.post("https://asclepius-server.herokuapp.com/api/post/prescriptions/new", prescData).then((response) => {
    ...
    const handlePickupOrder = async (prescData) => {
        ...
        await axios.put("https://asclepius-server.herokuapp.com/api/put/prescriptions/info/docnurse", prescriptionParams);
    ...
    useEffect(() => {
        const fetchStaffAndPatients = async () => {
            ...
            try {
                ...
                const assignedPatients = await axios.get('https://asclepius-server.herokuapp.com/api/get/staff/assignments/id', {params: staff});
                ...
                const requestedPrescriptions = await axios.get('https://asclepius-server.herokuapp.com/api/get/prescriptions/reqid', {params: staff});
